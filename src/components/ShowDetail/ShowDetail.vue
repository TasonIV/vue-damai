  ...
  <div class="show-detail">
    ...
    <div class="header-box">
      ...
      <div class="navbar clearfix">
        <i class="nav-left iconfont icon-zuo" @click="hideDetail()"></i>
    ...
    <div class="below-box">
      ...
      <van-sticky>
        <div class="tabbar border-1px">
          ...
          <span class="tab" :class="{active:type == 4}" @click="changeType(4)">推荐</span>
        </div>
      </van-sticky>
      ...
      <div
        ...
        @click="jump(list3)"
        v-show="type == 4"
        v-for="(list3,index) in listData4"
        :key="index"
      >
        <div class="table-img">
          <img v-lazy="list3.verticalPic" />
  ...
  methods: {
    ...
    jump(i) {
      if (this.$store.state.isLogin) {
        this.$router.push({ name: "indetail", params: { item: i } });
      } else {
    ...
    savePrice(a, b) {
      ...
      this.prices = 0;
      this.countNum = 0;
      this.performDate = a.performs[0].performName;
    },
    changePriceType(c, n) {
      this.priceType = n;
      ...
      if (this.prices) {
        Dialog.confirm({
          ...
          .then(() => {
            ...
            this.$store.commit("getPurchasedPerform", {
              img: this.item.verticalPic,
              title:this.item.name,
              time: this.performDate,
              unitPrice: this.currentPrice,
              num: this.countNum,
              price: this.prices,
              address: this.venue.venueAddr,
              bt: new Date().getTime(),   // 交易时间
              data: this.item,
            });
          })
          .catch(() => {
