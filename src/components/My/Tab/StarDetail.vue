<template>
  ...
  <div class="banner-star-box">
    ...
    <div class="header border-1px">
      <span class="close iconfont icon-zuo" @click="hideicon()"></span>
    ...
    <div class="container-box">
      ...
      <div class="detail-content">
        <div
          class="table detail-table border-1px"
          v-if="showItem.tourVO && showItem.tourVO.tourProjects"
        >
          <div class="table-img">
...
.detail-header {
  ...
  background: url("../../../../public/images/明星背景.png") no-repeat center
    center;
